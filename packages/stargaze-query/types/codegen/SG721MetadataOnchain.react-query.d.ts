...
export declare function useSG721MetadataOnchainCollectionInfoQuery<TData = CollectionInfoResponse>({ client, options }: SG721MetadataOnchainCollectionInfoQuery<TData>): any;
export interface SG721MetadataOnchainMinterQuery<TData> extends SG721MetadataOnchainReactQuery<MinterResponse, TData> {
}
export declare function useSG721MetadataOnchainMinterQuery<TData = MinterResponse>({ client, options }: SG721MetadataOnchainMinterQuery<TData>): any;
...
export declare function useSG721MetadataOnchainAllTokensQuery<TData = AllTokensResponse>({ client, args, options }: SG721MetadataOnchainAllTokensQuery<TData>): any;
...
export declare function useSG721MetadataOnchainTokensQuery<TData = TokensResponse>({ client, args, options }: SG721MetadataOnchainTokensQuery<TData>): any;
...
export declare function useSG721MetadataOnchainAllNftInfoQuery<TData = AllNftInfoResponse>({ client, args, options }: SG721MetadataOnchainAllNftInfoQuery<TData>): any;
export interface SG721MetadataOnchainNftInfoQuery<TData> extends SG721MetadataOnchainReactQuery<NftInfoResponse, TData> {
    args: {
        tokenId: string;
    };
}
export declare function useSG721MetadataOnchainNftInfoQuery<TData = NftInfoResponse>({ client, args, options }: SG721MetadataOnchainNftInfoQuery<TData>): any;
...
export declare function useSG721MetadataOnchainContractInfoQuery<TData = ContractInfoResponse>({ client, options }: SG721MetadataOnchainContractInfoQuery<TData>): any;
export interface SG721MetadataOnchainNumTokensQuery<TData> extends SG721MetadataOnchainReactQuery<NumTokensResponse, TData> {
}
export declare function useSG721MetadataOnchainNumTokensQuery<TData = NumTokensResponse>({ client, options }: SG721MetadataOnchainNumTokensQuery<TData>): any;
...
export declare function useSG721MetadataOnchainAllOperatorsQuery<TData = AllOperatorsResponse>({ client, args, options }: SG721MetadataOnchainAllOperatorsQuery<TData>): any;
...
export declare function useSG721MetadataOnchainApprovalsQuery<TData = ApprovalsResponse>({ client, args, options }: SG721MetadataOnchainApprovalsQuery<TData>): any;
...
export declare function useSG721MetadataOnchainApprovalQuery<TData = ApprovalResponse>({ client, args, options }: SG721MetadataOnchainApprovalQuery<TData>): any;
...
export declare function useSG721MetadataOnchainOwnerOfQuery<TData = OwnerOfResponse>({ client, args, options }: SG721MetadataOnchainOwnerOfQuery<TData>): any;
