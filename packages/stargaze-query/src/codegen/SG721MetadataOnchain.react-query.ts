...
export interface SG721MetadataOnchainOwnershipQuery<TData> extends SG721MetadataOnchainReactQuery<OwnershipResponse, TData> {}
export function useSG721MetadataOnchainOwnershipQuery<TData = OwnershipResponse>({
  client,
  options
}: SG721MetadataOnchainOwnershipQuery<TData>) {
  return useQuery<OwnershipResponse, Error, TData>(["sG721MetadataOnchainOwnership", client.contractAddress], () => client.ownership(), options);
}
