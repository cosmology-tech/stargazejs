...
export class BaseFactory extends ContractBase<BaseFactoryClient, IEmptyClient, BaseFactoryMessageComposer> {
  constructor({
    address,
    cosmWasmClient,
    signingCosmWasmClient
  }: IContractConstructor) {
    super(address, cosmWasmClient, signingCosmWasmClient, BaseFactoryClient, undefined, BaseFactoryMessageComposer);
  }
