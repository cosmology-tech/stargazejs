...
export class ReserveAuction extends ContractBase<ReserveAuctionClient, ReserveAuctionQueryClient, ReserveAuctionMessageComposer> {
  constructor({
    address,
    cosmWasmClient,
    signingCosmWasmClient
  }: IContractConstructor) {
    super(address, cosmWasmClient, signingCosmWasmClient, ReserveAuctionClient, ReserveAuctionQueryClient, ReserveAuctionMessageComposer);
  }
