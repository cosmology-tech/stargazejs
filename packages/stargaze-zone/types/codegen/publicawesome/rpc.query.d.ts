export declare const createRPCQueryClient: ({ rpcEndpoint }: {
    ...
    publicawesome: {
        stargaze: {
            alloc: {
                v1beta1: {
                    params(request?: import("../stargaze/alloc/v1beta1/query").QueryParamsRequest): Promise<import("../stargaze/alloc/v1beta1/query").QueryParamsResponseSDKType>;
                };
            };
            claim: {
                v1beta1: {
                    moduleAccountBalance(request?: import("../stargaze/claim/v1beta1/query").QueryModuleAccountBalanceRequest): Promise<import("../stargaze/claim/v1beta1/query").QueryModuleAccountBalanceResponseSDKType>;
                    params(request?: import("../stargaze/claim/v1beta1/query").QueryParamsRequest): Promise<import("../stargaze/claim/v1beta1/query").QueryParamsResponseSDKType>;
                    claimRecord(request: import("../stargaze/claim/v1beta1/query").QueryClaimRecordRequest): Promise<import("../stargaze/claim/v1beta1/query").QueryClaimRecordResponseSDKType>;
                    claimableForAction(request: import("../stargaze/claim/v1beta1/query").QueryClaimableForActionRequest): Promise<import("../stargaze/claim/v1beta1/query").QueryClaimableForActionResponseSDKType>;
                    totalClaimable(request: import("../stargaze/claim/v1beta1/query").QueryTotalClaimableRequest): Promise<import("../stargaze/claim/v1beta1/query").QueryTotalClaimableResponseSDKType>;
                };
            };
        };
    };
