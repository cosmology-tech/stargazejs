...
export const createRPCQueryClient = async ({
  ...
  publicawesome: {
    stargaze: {
      alloc: {
        v1beta1: new (await import("../stargaze/alloc/v1beta1/query.rpc.query")).QueryClientImpl(rpc)
      },
      claim: {
        v1beta1: new (await import("../stargaze/claim/v1beta1/query.rpc.query")).QueryClientImpl(rpc)
      }
    }
  }
});